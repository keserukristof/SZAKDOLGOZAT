...
var MainLayout = React.memo(function (_ref5) {
  ...
  return React.createElement(Grid, _extends({
    ...
    container: true,
    direction: "row"
  }, (renderTimeScale || !!groupingPanelSize) && React.createElement("div", {
  ...
  }, React.createElement(GroupingPanel, null), renderTimeScale && React.createElement("div", {
...
var TicksLayoutBase = function TicksLayoutBase(_ref) {
  ...
  return React.createElement(Table$2, _extends({}, restProps, {
    ...
    return React.createElement(Row, {
      ...
      endOfGroup: days[0].endOfGroup && groupOrientation === dxSchedulerCore.VERTICAL_GROUP_ORIENTATION,
  ...
  return {
    ...
    cell: {
      ...
      height: function height(_ref) {
        ...
        return "".concat(theme.spacing(SPACING_CELL_HEIGHT[dxSchedulerCore.VIEW_TYPES.WEEK]) * cellsCount, "px");
      }
    }
  };
});
...
var TickCellBase = React.memo(function (_ref) {
  var _classNames;
  ...
  _createClass(LayoutBase, [{
    ...
    value: function render() {
      ...
      return React.createElement(Table$2, _extends({
        ref: this.table,
        className: classNames(classes.table, className)
      }, restProps), React.createElement(TableBody, null, groupOrientation !== dxSchedulerCore.VERTICAL_GROUP_ORIENTATION && React.createElement(Row, null, cellsData.map(function (_ref) {
      ...
      })), groupOrientation === dxSchedulerCore.VERTICAL_GROUP_ORIENTATION && groups[groups.length - 1].map(function (group, index) {
        var groupingInfo = dxSchedulerCore.getGroupingInfoFromGroups(groups, index);
        return React.createElement(Row, {
...
var VerticalLayoutBase = function VerticalLayoutBase(_ref) {
  ...
  }, restProps), React.createElement(TableBody, null, groups[groups.length - 1].map(function (_, groupIndex) {
    return React.createElement(Row, {
      key: groupIndex.toString()
    }, dxSchedulerCore.getVerticalRowFromGroups(groups, groupIndex, rowSpan, timeTableCellHeight).map(function (_ref2) {
...
var useStyles$9 = styles$Y.makeStyles(function (theme) {
  return {
...
var AllDayCell = React.memo(function (_ref3) {
  var className = _ref3.className,
      group = _ref3.group,
  ...
  return React.createElement(Cell$6, _extends({
