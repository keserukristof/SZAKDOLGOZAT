...
export interface ConfirmationDialogProps {
  ...
  messages?: React.ComponentType<ConfirmationDialogBase.LocalizationMessages>;
}
...
export declare const DayView: React.ComponentType<DayViewProps> & {
  ...
  Row: React.ComponentType<DayViewBase.RowProps & { className?: string; style?: React.CSSProperties; [x: string]: any }>;
  /** A component that renders the appointment layer. */
...
export declare const MonthView: React.ComponentType<MonthViewProps> & {
  ...
  Row: React.ComponentType<MonthViewBase.RowProps & { className?: string; style?: React.CSSProperties; [x: string]: any }>;
  /** A component that renders the appointment layer. */
...
export declare const WeekView: React.ComponentType<WeekViewProps> & {
  ...
  Row: React.ComponentType<WeekViewBase.RowProps & { className?: string; style?: React.CSSProperties; [x: string]: any }>;
  /** A component that renders the appointment layer. */
