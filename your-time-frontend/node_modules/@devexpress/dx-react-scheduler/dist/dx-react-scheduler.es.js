...
var BasicViewBase = /*#__PURE__*/ (function (_super) {
    ...
    BasicViewBase.prototype.render = function () {
        ...
        return (createElement(Plugin, { name: "basicView" },
            ...
            createElement(Template, { name: "body" }, function (params) { return (createElement(TemplateConnector, null, function (_a) {
            ...
            createElement(Template, { name: "timeTable" },
                createElement(TemplateConnector, null, function (_a) {
                    ...
                    return (createElement(Fragment, null,
                        createElement(TimeTableLayout, { cellsData: viewCellsData, rowComponent: timeTableRowComponent, cellComponent: CellPlaceholder, formatDate: formatDate, setCellElementsMeta: _this.updateCellElementsMeta, key: timeTableLayoutKey }),
        ...
        return (createElement(Plugin, { name: "DayView" },
            ...
            createElement(Template, { name: "timeScale" },
                createElement(TemplateConnector, null, function (_a) {
                    ...
                    return (createElement(TimeScale, { labelComponent: TimeScaleLabel, tickCellComponent: timeScaleTickCellComponent, rowComponent: timeScaleTicksRowComponent, cellsData: viewCellsData, formatDate: formatDate, groups: groups, groupOrientation: groupOrientation }));
                }))));
    };
...
var renderAppointments = function (rects) { return rects.map(function (_a, index) {
    ...
    return (createElement(AppointmentPlaceholder, { key: index.toString(), type: rectType, data: dataItem, fromPrev: fromPrev, toNext: toNext, durationType: durationType, resources: resources, style: getAppointmentStyle(geometry) }));
}); };
...
var GroupingPanelPlaceholder$1 = function () { return createElement(TemplatePlaceholder, { name: "allDayGroupingPanel" }); };
    ...
    AllDayPanelBase.prototype.render = function () {
        ...
        return (createElement(Plugin, { name: "AllDayPanel", dependencies: pluginDependencies$3 },
            ...
            createElement(Template, { name: "body" }, function (params) { return (createElement(TemplateConnector, null, function (_a) {
                ...
                return (createElement(TemplatePlaceholder, { params: __assign(__assign({}, params), { highlightDayScale: (groupOrientation === null || groupOrientation === void 0 ? void 0 : groupOrientation(currentView.name)) === VERTICAL_GROUP_ORIENTATION }) }));
            })); }),
            createElement(Template, { name: "dayScaleEmptyCell" },
                createElement(TemplateConnector, null, function (_a) {
            ...
            createElement(Template, { name: "allDayPanel" },
                ...
                createElement(TemplateConnector, null, function (_a) {
                    ...
                    return (createElement(Fragment, null,
                        createElement(Layout, { cellComponent: CellPlaceholder$1, rowComponent: rowComponent, cellsData: _this.allDayCellsData(viewCellsData), setCellElementsMeta: _this.updateCellElementsMeta, formatDate: formatDate, groups: groupOrientation === VERTICAL_GROUP_ORIENTATION
        ...
        return (createElement(Plugin, { name: "GroupingPanel", dependencies: pluginDependencies$c },
            createElement(Template, { name: "groupingPanel" },
                createElement(TemplateConnector, null, function (_a) {
                    ...
                    return groupOrientation(currentView === null || currentView === void 0 ? void 0 : currentView.name) === HORIZONTAL_GROUP_ORIENTATION ? (createElement(HorizontalLayout, { rowComponent: rowComponent, cellComponent: cellComponent, groups: groups, colSpan: viewCellsData[0].length, cellStyle: {
            ...
            createElement(Template, { name: "allDayGroupingPanel" },
                createElement(TemplateConnector, null, function (_a) {
                    var groups = _a.groups, currentView = _a.currentView, groupOrientation = _a.groupOrientation;
                    return groupOrientation(currentView === null || currentView === void 0 ? void 0 : currentView.name) === VERTICAL_GROUP_ORIENTATION && (createElement(VerticalLayout, { rowComponent: rowComponent, cellComponent: allDayCellComponent, groups: groups, rowSpan: groups[groups.length - 1].length, viewType: VIEW_TYPES.ALL_DAY_PANEL }));
                }))));
    };
