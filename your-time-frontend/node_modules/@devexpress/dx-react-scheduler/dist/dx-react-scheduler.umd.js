...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var BasicViewBase = /*#__PURE__*/ (function (_super) {
        ...
        BasicViewBase.prototype.render = function () {
            ...
            return (React.createElement(dxReactCore.Plugin, { name: "basicView" },
                ...
                React.createElement(dxReactCore.Template, { name: "body" }, function (params) { return (React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                ...
                React.createElement(dxReactCore.Template, { name: "timeTable" },
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                        ...
                        return (React.createElement(React.Fragment, null,
                            React.createElement(TimeTableLayout, { cellsData: viewCellsData, rowComponent: timeTableRowComponent, cellComponent: CellPlaceholder, formatDate: formatDate, setCellElementsMeta: _this.updateCellElementsMeta, key: timeTableLayoutKey }),
        ...
        DayViewBase.prototype.render = function () {
            ...
            return (React.createElement(dxReactCore.Plugin, { name: "DayView" },
                ...
                React.createElement(dxReactCore.Template, { name: "timeScale" },
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                        var currentView = _a.currentView, viewCellsData = _a.viewCellsData, groups = _a.groups, formatDate = _a.formatDate, getGroupOrientation = _a.groupOrientation;
                        if (currentView.name !== viewName)
                            return React.createElement(dxReactCore.TemplatePlaceholder, null);
                        var groupOrientation = getGroupOrientation === null || getGroupOrientation === void 0 ? void 0 : getGroupOrientation(viewName);
                        return (React.createElement(TimeScale, { labelComponent: TimeScaleLabel, tickCellComponent: timeScaleTickCellComponent, rowComponent: timeScaleTicksRowComponent, cellsData: viewCellsData, formatDate: formatDate, groups: groups, groupOrientation: groupOrientation }));
                    }))));
        };
    ...
    var WeekViewBase = /*#__PURE__*/ (function (_super) {
        ...
        WeekViewBase.prototype.render = function () {
            ...
            return (React.createElement(dxReactCore.Plugin, { name: "WeekView" },
                ...
                React.createElement(dxReactCore.Template, { name: "timeScale" },
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                        var currentView = _a.currentView, viewCellsData = _a.viewCellsData, getGroupOrientation = _a.groupOrientation, groups = _a.groups, formatDate = _a.formatDate;
                        if (currentView.name !== viewName)
                            return React.createElement(dxReactCore.TemplatePlaceholder, null);
                        var groupOrientation = getGroupOrientation === null || getGroupOrientation === void 0 ? void 0 : getGroupOrientation(viewName);
                        return (React.createElement(TimeScale, { labelComponent: TimeScaleLabel, tickCellComponent: timeScaleTickCellComponent, rowComponent: timeScaleTicksRowComponent, cellsData: viewCellsData, formatDate: formatDate, groups: groups, groupOrientation: groupOrientation }));
    ...
    var renderAppointments = function (rects) { return rects.map(function (_a, index) {
        var dataItem = _a.dataItem, rectType = _a.type, fromPrev = _a.fromPrev, toNext = _a.toNext, durationType = _a.durationType, resources = _a.resources, geometry = __rest(_a, ["dataItem", "type", "fromPrev", "toNext", "durationType", "resources"]);
        return (React.createElement(AppointmentPlaceholder, { key: index.toString(), type: rectType, data: dataItem, fromPrev: fromPrev, toNext: toNext, durationType: durationType, resources: resources, style: dxSchedulerCore.getAppointmentStyle(geometry) }));
    }); };
    ...
    var AppointmentsBase = /*#__PURE__*/ (function (_super) {
        ...
        function AppointmentsBase() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.updateTimeTableAppointments = dxCore.memoize(function (timeTableAppointments, viewCellsData, timeTableElementsMeta, currentView, startViewDate, endViewDate, cellDuration, groups, getGroupOrientation, groupByDate) {
                ...
                return renderAppointments(dxSchedulerCore.calculateRectByDateAndGroupIntervals(appointmentType, timeTableAppointments, getRects, {
                    ...
                    viewCellsData: viewCellsData, cellElementsMeta: timeTableElementsMeta,
                }, {
            ...
            _this.updateAllDayAppointments = dxCore.memoize(function (allDayAppointments, viewCellsData, allDayElementsMeta, currentView, startViewDate, endViewDate, groups, getGroupOrientation, groupByDate) {
                ...
                return renderAppointments(dxSchedulerCore.calculateRectByDateAndGroupIntervals({ growDirection: dxSchedulerCore.HORIZONTAL_TYPE, multiline: false }, allDayAppointments, dxSchedulerCore.getHorizontalRectByAppointmentData, {
                    ...
                    viewCellsData: viewCellsData, cellElementsMeta: allDayElementsMeta,
                }, {
                    groupOrientation: groupOrientation,
                    groupedByDate: groupByDate === null || groupByDate === void 0 ? void 0 : groupByDate(currentView === null || currentView === void 0 ? void 0 : currentView.name),
                    groupCount: groupCount,
    ...
    var GroupingPanelPlaceholder$1 = function () { return React.createElement(dxReactCore.TemplatePlaceholder, { name: "allDayGroupingPanel" }); };
    var AllDayPanelBase = /*#__PURE__*/ (function (_super) {
        ...
        AllDayPanelBase.prototype.render = function () {
            ...
            return (React.createElement(dxReactCore.Plugin, { name: "AllDayPanel", dependencies: pluginDependencies$3 },
                ...
                React.createElement(dxReactCore.Template, { name: "body" }, function (params) { return (React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                    var groupOrientation = _a.groupOrientation, currentView = _a.currentView;
                    if (currentView.type === dxSchedulerCore.VIEW_TYPES.MONTH) {
                        return React.createElement(dxReactCore.TemplatePlaceholder, { params: __assign({}, params) });
                    }
                    return (React.createElement(dxReactCore.TemplatePlaceholder, { params: __assign(__assign({}, params), { highlightDayScale: (groupOrientation === null || groupOrientation === void 0 ? void 0 : groupOrientation(currentView.name)) === dxSchedulerCore.VERTICAL_GROUP_ORIENTATION }) }));
                })); }),
                React.createElement(dxReactCore.Template, { name: "dayScaleEmptyCell" },
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                        ...
                        if (currentView.type === dxSchedulerCore.VIEW_TYPES.MONTH)
                            return React.createElement(dxReactCore.TemplatePlaceholder, null);
                        if ((groupOrientation === null || groupOrientation === void 0 ? void 0 : groupOrientation(currentView.name)) === dxSchedulerCore.VERTICAL_GROUP_ORIENTATION) {
                            return (React.createElement(GroupingPanelPlaceholder$1, null));
                        }
                ...
                React.createElement(dxReactCore.Template, { name: "allDayPanel" },
                    React.createElement(dxReactCore.TemplatePlaceholder, null),
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                        var currentView = _a.currentView, formatDate = _a.formatDate, viewCellsData = _a.viewCellsData, groups = _a.groups, getGroupOrientation = _a.groupOrientation;
                        if (currentView.type === dxSchedulerCore.VIEW_TYPES.MONTH)
                            return null;
                        var groupOrientation = (getGroupOrientation === null || getGroupOrientation === void 0 ? void 0 : getGroupOrientation(currentView === null || currentView === void 0 ? void 0 : currentView.name)) || dxSchedulerCore.HORIZONTAL_GROUP_ORIENTATION;
                        return (React.createElement(React.Fragment, null,
                            React.createElement(Layout, { cellComponent: CellPlaceholder$1, rowComponent: rowComponent, cellsData: _this.allDayCellsData(viewCellsData), setCellElementsMeta: _this.updateCellElementsMeta, formatDate: formatDate, groups: groupOrientation === dxSchedulerCore.VERTICAL_GROUP_ORIENTATION
                                    ? groups : undefined, groupOrientation: groupOrientation, key: layoutKey }),
                            React.createElement(AppointmentLayer, null,
    ...
    var DragDropProviderBase = /*#__PURE__*/ (function (_super) {
        ...
        DragDropProviderBase.prototype.calculateBoundaries = function (_a, _b, _c) {
            ...
            if (allDayIndex === -1 && timeTableIndex === -1)
                return;
            var targetData = dxSchedulerCore.cellData(timeTableIndex, allDayIndex, viewCellsData, groups, groupOrientation);
        ...
        DragDropProviderBase.prototype.render = function () {
            ...
            var _b = this.props, Container = _b.containerComponent, DraftAppointment = _b.draftAppointmentComponent, SourceAppointment = _b.sourceAppointmentComponent, Resize = _b.resizeComponent, allowDrag = _b.allowDrag, allowResize = _b.allowResize;
            ...
            return (React.createElement(dxReactCore.Plugin, { name: "DragDropProvider", dependencies: pluginDependencies$6 },
                React.createElement(dxReactCore.Template, { name: "body" },
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a, _b) {
                        var viewCellsData = _a.viewCellsData, startViewDate = _a.startViewDate, endViewDate = _a.endViewDate, excludedDays = _a.excludedDays, timeTableElementsMeta = _a.timeTableElementsMeta, allDayElementsMeta = _a.allDayElementsMeta, scrollingStrategy = _a.scrollingStrategy, grouping = _a.grouping, resources = _a.resources, groups = _a.groups, currentView = _a.currentView, groupByDate = _a.groupByDate, groupOrientation = _a.groupOrientation;
                        ...
                        var calculateBoundariesByMove = _this.calculateNextBoundaries({
                            viewCellsData: viewCellsData, currentView: currentView, startViewDate: startViewDate, endViewDate: endViewDate, excludedDays: excludedDays,
    ...
    var GroupingPanelBase = /*#__PURE__*/ (function (_super) {
        ...
        GroupingPanelBase.prototype.render = function () {
            var _a = this.props, HorizontalLayout = _a.horizontalLayoutComponent, VerticalLayout = _a.verticalLayoutComponent, rowComponent = _a.rowComponent, cellComponent = _a.cellComponent, allDayCellComponent = _a.allDayCellComponent;
            return (React.createElement(dxReactCore.Plugin, { name: "GroupingPanel", dependencies: pluginDependencies$c },
                React.createElement(dxReactCore.Template, { name: "groupingPanel" },
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                        var viewCellsData = _a.viewCellsData, currentView = _a.currentView, scrollingStrategy = _a.scrollingStrategy, groupByDate = _a.groupByDate, groupOrientation = _a.groupOrientation, groups = _a.groups;
                        return groupOrientation(currentView === null || currentView === void 0 ? void 0 : currentView.name) === dxSchedulerCore.HORIZONTAL_GROUP_ORIENTATION ? (React.createElement(HorizontalLayout, { rowComponent: rowComponent, cellComponent: cellComponent, groups: groups, colSpan: viewCellsData[0].length, cellStyle: {
                ...
                React.createElement(dxReactCore.Template, { name: "allDayGroupingPanel" },
                    React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                        var groups = _a.groups, currentView = _a.currentView, groupOrientation = _a.groupOrientation;
                        return groupOrientation(currentView === null || currentView === void 0 ? void 0 : currentView.name) === dxSchedulerCore.VERTICAL_GROUP_ORIENTATION && (React.createElement(VerticalLayout, { rowComponent: rowComponent, cellComponent: allDayCellComponent, groups: groups, rowSpan: groups[groups.length - 1].length, viewType: dxSchedulerCore.VIEW_TYPES.ALL_DAY_PANEL }));
                    }))));
        };
