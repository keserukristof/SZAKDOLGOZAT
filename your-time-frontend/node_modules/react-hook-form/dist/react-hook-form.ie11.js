...
function useForm(_a) {
  ...
  function watch(fieldNames, defaultValue) {
    var combinedDefaultValues = isDirtyRef.current ? {} : isUndefined(defaultValue) ? isUndefined(defaultValuesRef.current) ? {} : defaultValuesRef.current : defaultValue;
...
var useFieldArray = function (_a) {
  ...
  var memoizedDefaultValues = useRef$1(fieldArrayDefaultValues.current[name] || __spread(get$1(defaultValuesRef.current, name, [])));
  ...
  var _e = __read(useState$1(false), 2),
      isDeleted = _e[0],
      setIsDeleted = _e[1];
  ...
  var reset = function () {
    resetFields();
    memoizedDefaultValues.current = __spread(get$1(defaultValuesRef.current, name, []));
