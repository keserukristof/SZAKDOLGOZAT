...
var resolveFieldData = function resolveFieldData(state, dispatch, getAllValues) {
...
var resolveField = function resolveField(fieldState, dispatch, getAllValues) {
  ...
  switch (fieldType) {
    ...
    case 'list':
      return (0, _fields.useListField)(fieldState, dispatch, field, getAllValues);
...
var getFieldProps = function getFieldProps(fieldData) {
  ...
  return Object.entries(fieldData).reduce(function (acc, _ref3) {
    ...
    acc[key] = (0, _objectSpread2.default)({}, v.props, passThrough);
    return acc;
  }, {});
};
